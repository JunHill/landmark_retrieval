...
flags.DEFINE_integer('num_classes', None, 'Number class of training dataset.')
...
def main(argv):
  ...
  if FLAGS.num_classes:
    ...
    raise ValueError("Need define num class")
      ...
      with tf.summary.record_if(record_cond):
        ...
        while global_step_value < max_iters:
          ...
          if (global_step_value % save_interval == 0) or (global_step_value >= max_iters):
            ...
            logging.info('Saved weights (%d) at %s', global_step_value, file_path)
